...
const TransactionEdit: React.FC<Props> = ({ transaction, accounts }) => {
            ...
            <div className="max-w-5xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Modify existing transaction</p>
                    </div>
                    <Link
                        href="/transactions"
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border p-6 space-y-6">
                                    ...
                                    <div className="col-span-2">
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (e.target.value) updateEntry(index, 'credit', '0');
                                            }}
                                    ...
                                    <div className="col-span-2">
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (e.target.value) updateEntry(index, 'debit', '0');
                                            }}
                                            className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 text-right"
                                            placeholder="0.00"
                                        />
                    ...
                    <div className="flex items-center justify-end space-x-4 pt-6 border-t">
                        ...
                        >
                            ...
                            <span>{processing ? 'Updating...' : 'Update Transaction'}</span>
                        </button>
                    </div>
                </form>
            </div>
