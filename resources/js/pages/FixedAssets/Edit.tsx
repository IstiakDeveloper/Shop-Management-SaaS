...
const FixedAssetsEdit: React.FC<Props> = ({ asset, statuses }) => {
        ...
        <AppLayout>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Edit Fixed Asset</h1>
                        <p className="text-gray-600 mt-1">Modify asset details</p>
                    </div>
                    <Link
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border p-6 space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setData('accumulated_depreciation', e.target.value)}
                                className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 ${
                                    errors.accumulated_depreciation ? 'border-red-500' : ''
                                }`}
                                placeholder="0.00"
                            />
                            {errors.accumulated_depreciation && (
                                <p className="mt-1 text-sm text-red-600">{errors.accumulated_depreciation}</p>
                            )}
                            <p className="text-xs text-gray-500 mt-1">
                                Total depreciation accumulated since purchase
                            </p>
                        </div>
                    ...
                    <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                        <p className="text-sm text-blue-800">
                            ...
                            {(Number(data.cost) - Number(data.accumulated_depreciation)).toLocaleString('en-BD', {
                    ...
                    <div className="flex items-center justify-end space-x-4 pt-6 border-t">
                        ...
                        >
                            ...
                            <span>{processing ? 'Updating...' : 'Update Asset'}</span>
                        </button>
                    </div>
                </form>
            </div>
