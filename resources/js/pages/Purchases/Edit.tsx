...
const PurchaseEdit: React.FC<Props> = ({ purchase, vendors, products }) => {
            ...
            <div className="max-w-6xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Update purchase details, stock & bank will be adjusted</p>
                    </div>
                    <Link
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                    <p className="text-sm text-yellow-800">
                        <strong>Important:</strong> Editing will reverse old stock entries and bank transactions, then apply new ones. Use carefully!
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-end space-x-4 bg-white rounded-xl shadow-sm border p-6">
                        ...
                        >
                            ...
                            <span>{processing ? 'Updating...' : 'Update Purchase'}</span>
                        </button>
                    </div>
                </form>
            </div>
